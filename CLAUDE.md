...
実利用開始前の法務・セキュリティ課題は `docs/legal/LEGAL_AUDIT_BACKLOG.md` を参照する。個人情報、投稿、DM、外部送信、決済、広告、生成AIを変更する作業では、着手前と完了時に同台帳を確認する。
...
| `legal-check` | sonnet / xhigh | 個人情報の項目追加・表示・外部送信・保管場所変更、投稿系機能、外部サービス追加をしたらコミット前に（個人情報保護法・著作権・投稿対応・外部送信規律・守秘義務） |
