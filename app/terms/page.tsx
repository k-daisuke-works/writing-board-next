        ...
        <div className="bg-white rounded-[28px] px-6 py-8 sm:px-10 sm:py-10 shadow-sm">
          ...
          <Section title="4の2. ダイレクトメッセージの取扱い">
            <p>
              ...
              DMの内容は、通常のシステム機能を通じては当事者以外（運営者および利用団体の管理者を含む）が閲覧できない設計としています。
              保守・障害対応のためデータベースへ直接アクセスする権限を持つ運営者も、保守目的以外でDMの内容にアクセスしません。
            </p>
            <p>
              当事者の一方が「管理者に報告」の操作を行った場合に限り、当該スレッドの内容が
              利用団体の管理者に開示されます（開示の操作および管理者の閲覧はいずれも記録されます）。
              ハラスメント等のトラブルの際はこの報告機能を利用してください。
              DMにも第3条の禁止事項が適用され、違反があった場合、管理者は報告されたスレッドの確認のほか、
              アカウントの凍結等の措置を行うことがあります。
            </p>
          </Section>
