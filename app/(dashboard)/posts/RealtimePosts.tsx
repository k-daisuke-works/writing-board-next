...
import { Plus, Clock, Paperclip, Building2, ChevronRight, Wifi, Image, Video } from 'lucide-react'
                    ...
                    {post ? (
                      <>
                        ...
                        <div className="flex items-start gap-2">
                          <p className="flex-1 text-sm text-gray-700 line-clamp-3 leading-relaxed">
                            {post.message}
                          </p>
                          {post.image_url && (
                            <img
                        ...
                        <div className="flex items-center justify-between mt-3">
                          <div className="flex items-center gap-2">
                            ...
                            {post.video_url && !post.image_url && (
                              <span className="flex items-center gap-1 text-xs text-gray-400">
                                <Video className="w-3 h-3" />動画
                              </span>
                            )}
                            {post.image_url && (
                              <span className="flex items-center gap-1 text-xs text-gray-400">
                                <Image className="w-3 h-3" />画像
                              </span>
                            )}
                          </div>
                          <span className="flex items-center gap-1 text-xs text-gray-400">
